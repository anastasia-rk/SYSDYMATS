...
\begin{table}[!h]
	...
	\small
	\input{Betas_direct_T_2000.tex}
\end{table}

\begin{figure}[!h]
	\centering
	\subfloat[C3]{\input{C3_gen_y_direct_T_2000.tikz}\label{fig:c3all}}\\
	\subfloat[C8]{\input{C8_gen_y_direct_T_2000.tikz}\label{fig:c8all}}
