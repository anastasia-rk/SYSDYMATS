...
t_0 = lambda+100;
T   = 9500; %length(Input); % length of the observation sequence
dT  = 0.01;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for t=timesNarx
    ...
    switch direction
        case 'Backward'
            ...
            for it=1:lambda
                x_narx(it,iNarx)      = delta_operator(it,Output,t,dT,direction);
            end
            t = t-1;
        case 'Forward'
    ...
    for it=lambda+2:2*lambda
        x_narx(it,iNarx)      = delta_operator(it-lambda-1,Input,t,dT,direction);
    end
